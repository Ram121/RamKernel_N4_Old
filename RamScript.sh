...
#Making zip
7z a -tzip -mx5 $(pwd)/bootimg/zips/RamKernel_$1$2_V6_$selinux.zip $(pwd)/bootimg/zips/template/META-INF $(pwd)/bootimg/zips/template/system $(pwd)/bootimg/zips/template/boot.img #removed $(pwd)/bootimg/zips/template/ram
