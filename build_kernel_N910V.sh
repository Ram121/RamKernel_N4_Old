...
cp bootimg/stock_bootimg/N910V/boot.img $(pwd)/bootimg/AIK-Linux-2.4
...
7z a -tzip -mx5 $(pwd)/bootimg/zips/RamKernel_N910V_All.zip $(pwd)/bootimg/zips/template/META-INF $(pwd)/bootimg/zips/template/root $(pwd)/bootimg/zips/template/system $(pwd)/bootimg/zips/template/boot.img
